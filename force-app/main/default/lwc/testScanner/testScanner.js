...
import CODEBAR_FIELD from "@salesforce/schema/Opportunity.Test_CodeBar__c";
...
export default class BarcodeScannerExample extends LightningElement {
    ...
    handleBeginScanClick(event) {
        ...
        if (this.myScanner != null && this.myScanner.isAvailable()) {
            const scanningOptions = {
                barcodeTypes: [this.myScanner.barcodeTypes.QR, this.myScanner.barcodeTypes.CODE_128, this.myScanner.barcodeTypes.PDF_417],
                instructionText: 'Scan a Code',
    ...
    refreshView() {
        ...
        getRecordNotifyChange([{ recordId: this.getIdFromParent }]);
        this.scannedBarcode = '';
    ...
    handleSave(){
        ...
        fields[CODEBAR_FIELD.fieldApiName] = this.scannedBarcode;
